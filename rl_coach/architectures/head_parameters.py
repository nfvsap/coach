...
class DuelingQHeadCustomParameters(HeadParameters):
    def __init__(self, activation_function: str ='relu', name: str='dueling_q_head_custom_params',
                 num_output_head_copies: int = 1, rescale_gradient_from_head_by_factor: float = 1.0,
                 loss_weight: float = 1.0, dense_layer=None, number_layers: int = 1, units: int = 15):
